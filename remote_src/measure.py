...
# sudo HOME=/home/twuttge/ PATH="$PATH" VIRTUAL_ENV="$VIRTUAL_ENV"  python3 -c 'from remote_src.measure import measure; measure("test", "test");'
def measure(filename, timestamp):
